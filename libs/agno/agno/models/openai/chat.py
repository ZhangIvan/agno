...
class OpenAIChat(Model):
    ...
    def _format_all_messages(
        ...
        Also handles tool-image injection: The OpenAI Chat Completions API only supports
        multimodal content (images) in role='user' messages. Images placed in role='tool'
        messages are silently ignored. This method strips images from tool messages and
        appends a synthetic user message carrying those images.
        """
