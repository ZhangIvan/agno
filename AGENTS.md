...
This project is indexed by GitNexus as **agno** (77619 symbols, 153109 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/agno/context` | Codebase overview, check index freshness |
| `gitnexus://repo/agno/clusters` | All functional areas |
| `gitnexus://repo/agno/processes` | All execution flows |
| `gitnexus://repo/agno/process/{name}` | Step-by-step execution trace |
